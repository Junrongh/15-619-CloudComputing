...
json() {
    ...
    :
    pythonioencoding=utf-8 python3 readjson.py
...
filter() {
    ...
    :
    # MacOS:
    # zcat < pageviews-20161109-000000.gz | python3 data_filter.py
    # Linux:
    # zcat pageviews-20161109-000000.gz | python3 data_filter.py
}
...
q1() {
    ...
    # <record>
    :
    awk '/Electoral_College_\(United_States\)/' output
}
...
q3() {
    ...
    # <number>
    :
    awk '/Donald_Trump/{x=x+$2}END{print x}' output
}
...
q8() {
    ...
    # <number>
    :
grep -c -i '[^a-zA-Z0-9]Cloud[^a-zA-Z0-9]' output
}
